...
type
  TEmpresas = class(TForm)
    ...
    cNumEntradas: TcxDBTextEdit;
    cNumSalidas: TcxDBTextEdit;
    cNumFacturas: TcxDBTextEdit;
    cNumContabilizar: TcxDBTextEdit;
    Panel1: TPanel;
    ...
    cCtaIngresos: TcxDBTextEdit;
    cCtaIngresosAna: TcxDBTextEdit;
    cSeccion: TcxDBTextEdit;
    cUltimoUsuario: TcxDBTextEdit;
    cPlanta: TcxDBTextEdit;
    cIva: TcxDBTextEdit;
    cCtaIva: TcxDBTextEdit;
...
//    procedure Busqueda(Sender: TObject);
    ...
    procedure cCodigoPostalExit(Sender: TObject);
    procedure Busqueda(Sender: TObject);
...
uses UGLobal, MBaseDatos, DM, BEmpresas;//, BTarifas, BEmpresas;
...
//----------------------------- BUSQUEDA ---------------------------------------
{
procedure TEmpresas.Busqueda(Sender: TObject);
Var
...
procedure TEmpresas.cCodigoPostalExit(Sender: TObject);
begin
     if (QMaestro.State in dsEditModes) then
     begin
