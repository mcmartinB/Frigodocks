object Conceptos: TConceptos
  ...
  object PanelDatos: TPanel
    ...
    object cDescripcion: TcxDBTextEdit
      Left = 192
      Top = 24
      DataBinding.DataField = 'descripcion_c'
    ...
    object cTipo: TcxDBRadioGroup
      Left = 84
      Top = 61
      DataBinding.DataField = 'tipo_c'
      DataBinding.DataSource = DSMaestro
      Properties.Columns = 3
      Properties.DefaultValue = '0'
      Properties.Items = <
        item
          Caption = 'Elect. Oficina'
          Value = 'O'
        end
        item
          Caption = 'Elect. Carretilla'
          Value = 'C'
        end
        item
          Caption = 'Kw Thermoking'
          Value = 'T'
        end>
      TabOrder = 2
      Height = 44
  ...
  object QMaestro: TQuery
    ...
    object QMaestroempresa_c: TStringField
      FieldName = 'empresa_c'
      Origin = 'BDFRIGO.conceptos.empresa_c'
      Size = 3
    end
    object QMaestrocodigo_c: TStringField
      FieldName = 'codigo_c'
      Origin = 'BDFRIGO.conceptos.codigo_c'
      Size = 3
    end
    object QMaestrodescripcion_c: TStringField
      FieldName = 'descripcion_c'
      Origin = 'BDFRIGO.conceptos.descripcion_c'
      Size = 50
    end
    object QMaestrotipo_c: TStringField
      FieldName = 'tipo_c'
      Origin = 'BDFRIGO.conceptos.tipo_c'
      Size = 1
    end
  end
