object BusquedaEntradas: TBusquedaEntradas
  Left = 216
  Top = 246
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Busqueda Albaranes Entrada'
  ClientHeight = 522
  ClientWidth = 475
  Color = clBtnFace
  ...
  object ClientDataSet1: TClientDataSet
    ...
    Left = 303
    Top = 114
    object ClientDataSet1empresa_ce: TStringField
      FieldName = 'empresa_ce'
      FixedChar = True
      Size = 3
    end
    object ClientDataSet1albaran_ce: TIntegerField
      FieldName = 'albaran_ce'
    end
    object ClientDataSet1cliente_ce: TStringField
      FieldName = 'cliente_ce'
      FixedChar = True
      Size = 4
    end
    object ClientDataSet1importe_entrada_ce: TFloatField
      FieldName = 'importe_entrada_ce'
    end
    object ClientDataSet1horas_entrada_ce: TFloatField
      FieldName = 'horas_entrada_ce'
    end
    object ClientDataSet1numero_factura_ce: TIntegerField
      FieldName = 'numero_factura_ce'
    end
    object ClientDataSet1temperatura_ce: TSmallintField
      FieldName = 'temperatura_ce'
    end
    object ClientDataSet1concepto_ce: TStringField
      FieldName = 'concepto_ce'
      FixedChar = True
      Size = 60
    end
    object ClientDataSet1tipo_entrada_ce: TStringField
      FieldName = 'tipo_entrada_ce'
      FixedChar = True
      Size = 1
    end
    object ClientDataSet1transportista_ce: TStringField
      FieldName = 'transportista_ce'
      FixedChar = True
      Size = 30
    end
    object ClientDataSet1matricula_ce: TStringField
      FieldName = 'matricula_ce'
      FixedChar = True
      Size = 15
    end
    object ClientDataSet1procedencia_ce: TStringField
      FieldName = 'procedencia_ce'
      FixedChar = True
      Size = 30
    end
    object ClientDataSet1observaciones_ce: TStringField
      FieldName = 'observaciones_ce'
      FixedChar = True
      Size = 30
    end
    object ClientDataSet1concepto2_ce: TStringField
      FieldName = 'concepto2_ce'
      FixedChar = True
      Size = 15
    end
    object ClientDataSet1hora_ce: TStringField
      FieldName = 'hora_ce'
      FixedChar = True
      Size = 8
    end
    object ClientDataSet1fecha_albaran_ce: TStringField
      FieldName = 'fecha_albaran_ce'
      FixedChar = True
      Size = 10
    end
    object ClientDataSet1fecha_factura_ce: TStringField
