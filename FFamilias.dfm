object Familias: TFamilias
  ...
  object PanelDatos: TPanel
    ...
    object cDenominacion: TcxDBTextEdit
      Left = 183
      Top = 27
      DataBinding.DataField = 'descripcion_f'
  ...
  object QMaestro: TQuery
    ...
    Left = 528
    Top = 41
    object QMaestroempresa_f: TStringField
      FieldName = 'empresa_f'
      Origin = 'BDFRIGO.familias.empresa_f'
      FixedChar = True
      Size = 3
    end
    object QMaestrocodigo_f: TStringField
      FieldName = 'codigo_f'
      Origin = 'BDFRIGO.familias.codigo_f'
      FixedChar = True
      Size = 3
    end
    object QMaestrodescripcion_f: TStringField
      FieldName = 'descripcion_f'
      Origin = 'BDFRIGO.familias.descripcion_f'
      FixedChar = True
      Size = 30
    end
  end
